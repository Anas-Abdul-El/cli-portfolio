...
1. e-commerce backend using express: e-commerce backend built using Express 5, TypeScript, Prisma, JWT, bcrypt, Zod, Supabase, Nodemailer, Helmet, CORS, rate-limiting, multer.\n  
2. Portfolio Website: A personal website built with React and TypeScript to showcase my skills and projects.\n
